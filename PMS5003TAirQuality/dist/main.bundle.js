...
var SettingPageComponent = /** @class */ (function () {
    ...
    SettingPageComponent.prototype.deviceChange = function (i, device, type) {
        ...
        while (__WEBPACK_IMPORTED_MODULE_6_lodash__["findIndex"](this.userDevices, [1, "text"]) >= 0) {
            this.userDevices.splice(__WEBPACK_IMPORTED_MODULE_6_lodash__["findIndex"](this.userDevices, [1, "text"]), 1);
        }
